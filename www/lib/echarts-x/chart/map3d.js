define('echarts-x/chart/map3d', [
    ...
    Map3D.prototype = {
        ...
        _createMapRootNode: function (seriesGroup) {
            ...
            camera.position.z = radius * (isFlatMap ? 1 : 4.2);
            camera.position.y = 0;
        ...
        _initMapHandlers: function (seriesGroup) {
            ...
            var mouseEventHandler = function (e) {
                ...
                var shape;
                if (e.type === zrConfig.EVENT.CLICK || e.type === zrConfig.EVENT.DBLCLICK) {
                    shape = this._globeSurface.hover(x, y);
                }
    ...
    ZRenderSurface.prototype = {
        ...
        hover: function (x, y) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                // var item = list[i];
                // if(item == shape && !item.isHighlight){
                //     item.isHighlight = true;
                //     item.zlevel = 10;
                //     // item.brush(ctx, item.isHighlight);
                //     needsRefresh = true;
                //     this._shapesToUpdate.push(item);
                // }else if(item != shape && item.isHighlight){
